                    ...
                    >
                        <div className="mt-10 flex flex-col md:flex-row items-start gap-10 md:gap-16">
                                ...
                                {layers.map((layer, i) => (
                                    ...
                                    >
                                        <div className="flex flex-col items-center w-4 shrink-0">
                                            ...
                                            />
                                            {i < layers.length - 1 && (
                                                <div className="w-px h-6 bg-neutral-200/50 dark:bg-neutral-800/50" />
                                            )}
                                        </div>
                                        <span
                            ...
                            <div className="hidden md:flex items-center self-center">
                                <div className="w-16 h-px bg-neutral-200/50 dark:bg-neutral-800/50" />
                            ...
                            {/* Right: Flagship */}
                            <div
                                className={`rounded-lg border px-5 py-4 transition-colors duration-200 self-center ${active !== null
